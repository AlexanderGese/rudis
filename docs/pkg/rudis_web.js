...
export class Db {
    ...
    exec(line, now) {
        ...
        try {
            ...
            const ret = wasm.db_exec(this.__wbg_ptr, ptr0, len0, now);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    stats() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.db_stats(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rudis_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
